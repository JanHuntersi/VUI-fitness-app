  ...
  return (
    <div className='m-8'>
      ...
      {loading ? (
        ...
        <div>
      <div className='bg-white p-6 rounded-lg shadow-xl border border-gray-300 mb-3'>
        <div className='pb-6'>
        <h2 className='text-xl font-semibold leading-7 text-gray-900'>Workouts</h2>
            {userInfo.workouts && (
            ...
            <div className='flex justify-center mt-6'>
              <Link
                to='/workout/new'
                className='rounded-md bg-indigo-600 px-7 py-4 text-xl font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
              >
                Create new workout
              </Link>
            </div>
       ...
       <div className='bg-white p-6 rounded-lg shadow-xl border border-gray-300 mt-3'>
